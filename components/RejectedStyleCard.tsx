...
export const RejectedStyleCard: React.FC<RejectedStyleCardProps> = ({ title, reason, index }) => {
  ...
  return (
    <div 
      className="bg-gray-100 rounded-xl shadow-md overflow-hidden border border-gray-200 animate-fade-in-stagger"
      ...
      <div className="p-6">
        <div className="flex items-center gap-3">
            ...
            <div>
                ...
                <p className="text-xs text-gray-500 font-medium">{t('rejectedCard.title')}</p>
            </div>
        </div>
        <div className="mt-3 pt-3 border-t">
            <p className="text-sm text-gray-700 font-semibold mb-1">{t('rejectedCard.subtitle')}</p>
